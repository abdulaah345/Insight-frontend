...
//   const handleChartTypeChange = (newChartType: React.SetStateAction<string>) => {
...
//           <select className="form-select mb-3" onChange={(e) => handleChartTypeChange(e.target.value)}>
...
//           {/* Render specific parameters based on selected chart type */}
//           {chartType === 'histogram' && (
//             <div className="mb-3">
      ...
      <div className="card">
        <div className="card-body">
          ...
          <div>
              ...
              <input type="text" className="form-control mb-3" value={title} onChange={(e) => setTitle(e.target.value)} />
              ...
              <input type="text" className="form-control mb-3" value={xLabel} onChange={(e) => setXLabel(e.target.value)} />

              <label className="form-label">Y Label :</label>
              <input type="text" className="form-control mb-3" value={yLabel} onChange={(e) => setYLabel(e.target.value)} />
              
                <label className="form-label">Color:</label>
                <input type="color" className="form-control mb-3" value={color} onChange={(e) => setColor(e.target.value)} />
              </div>
            )} 
          </div>
          ...
          {chartType === 'histogram' && (
            <div>
              ...
              <select className="form-select mb-3" value={function_type} onChange={(e) => setFunction_type(e.target.value)}>
              ...
              <select className="form-select mb-3" value={columnToDistribute} onChange={(e) => setColumnToDistribute(e.target.value)}>
                <option value="data">data</option>

              </select>
           
              <label className="form-label">Number of Bins:</label>
              <input type="number" className="form-control mb-3" value={numberOfBins} onChange={(e) => setNumberOfBins(e.target.value)} />

              <label className="form-label">Normalization Type:</label>
              <select className="form-select mb-3" value={normalizationType} onChange={(e) => setNormalizationType(e.target.value)}>
          ...
          {chartType==='line' && (
            <div>
                ...
                <select className="form-select mb-3" value={lineshape} onChange={(e)=>setLinesaphe(e.target.value)}>
            ...
            <div>
                ...
                <select className="form-select mb-3" value={Barmode} onChange={(e)=>setBarmode(e.target.value)}>
           ...
           {chartType === 'boxPlot' && (
            <div>
              <label className="form-label">Column to Distribute:</label>
              <input type="text" className="form-control mb-3" value={columnToDistribute} onChange={(e) => setColumnToDistribute(e.target.value)} />

              <label className="form-label">Data Points to Show:</label>
              <select className="form-select mb-3" value={dataPointsToShow} onChange={(e) => setDataPointsToShow(e.target.value)}>
            ...
            <div>
              ...
              <input type="number" className="form-control mb-3" value={scatterSize} onChange={(e) => setScatterSize(e.target.value)} />

              <label className="form-label">Distribute with Color :</label>
              <select className="form-select mb-3" value={scatterColor} onChange={(e) => setScatterColor(e.target.value)}>
                <option value="data">data</option>

              </select>
              <label className="form-label">Distribute with Symbols :</label>
              <select className="form-select mb-3" value={scatterSymbols} onChange={(e) => setScatterSymbols(e.target.value)}>
                <option value="data">data</option>
            ...
            <div>
              ...
              <input type="text" className="form-control mb-3" value={names} onChange={(e) => setNames(e.target.value)} />

              <label className="form-label">Values :</label>
              <input type="text" className="form-control mb-3" value={values} onChange={(e) => setValues(e.target.value)} />
            </div>
          )}
        </div>
      </div>
