...
//   // Replace with your categorical data
//   const categoricalData = ['Category A', 'Category B', 'Category A', 'Category C', 'Category B', 'Category A'];
...
//   const frequencyMap: Category = {};
  
//   categoricalData.forEach((category) => {
//     frequencyMap[category] = (frequencyMap[category] || 0) + 1;
//   });
  

//   // Calculate Percentage
//   const totalCategories = categoricalData.length;
//   interface ss {
//     [key: string]: number;
//   }
//   const percentageMap:ss = {};
//   Object.keys(frequencyMap).forEach((category) => {

//     percentageMap[category] = (frequencyMap[category] / totalCategories) * 100;
//   });

//   return (
//     <div>
//       <h2>Categorical Data Statistics</h2>
...
//         </thead>
//         <tbody>
//           {Object.keys(frequencyMap).map((category) => (
//             <tr key={category}>
//               <td>{category}</td>
//               <td>{frequencyMap[category]}</td>
//               <td>{percentageMap[category].toFixed(2)}%</td>
//             </tr>
//           ))}
//         </tbody>
//       </table>
        ...
        <div key={index}>
          ...
          <div className="table-responsive">
            <table className="table table-bordered">
              ...
              <tbody>
                {Object.entries(calculateFrequency(columnName)).map(([category, frequency], catIndex) => (
                  <tr key={catIndex}>
                    <td>{category}</td>
                    <td>{frequency}</td>
                    <td>{calculatePercentage(columnName)[category].toFixed(2)}%</td>
                  </tr>
                ))}
              </tbody>
            </table>
